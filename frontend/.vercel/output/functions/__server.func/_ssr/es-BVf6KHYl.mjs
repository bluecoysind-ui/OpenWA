//#region node_modules/.nitro/vite/services/ssr/assets/es-BVf6KHYl.js
var toast = { "connectionLost": {
	"title": "Conexión con el servidor perdida",
	"message": "No se puede acceder al servidor backend. Comprueba si el servidor está en ejecución."
} };
var common = {
	"appName": "OpenWA",
	"loading": "Cargando...",
...
var chats = {
	...
	"noSessionsDesc": "Conecta primero una sesión de WhatsApp desde el menú <1>Sesiones</1> para usar el chat.",
	...
	"loadOlderMessagesError": "No se pudieron cargar los mensajes anteriores. Desplázate hacia arriba para reintentar.",
	...
	"scrollToBottom": "Ir al más reciente",
	"groupSubtitle": "Grupo",
	"privateContactSubtitle": "Contacto privado",
	"deleteConfirm": "¿Eliminar este mensaje para todos?",
	"promptButtons": "Opciones del mensaje",
	"messageDeleted": "🚫 Este mensaje fue eliminado",
	"messageMasked": "🔒 Ocultado por WhatsApp en dispositivos vinculados — revísalo en tu teléfono principal",
	"kind": {
		"group": "Grupo",
		"channel": "Canal",
		"status": "Estado",
	...
	"status": {
		...
		"composeText": "Texto",
		"composeImage": "Imagen",
		"recipients": "Quién puede ver esto",
		"recipientsHint": "Baileys requiere una lista de destinatarios; whatsapp-web.js usa tu audiencia de privacidad de estado.",
		...
		"orLabel": "o",
		"post": "Publicar",
		"posted": "Estado publicado",
		"postFailed": "No se pudo publicar el estado",
		"imageFile": "Imagen de estado"
	},
	"channels": {
	...
	"errors": {
		...
		"clickButton": "Error al pulsar el botón",
		"fileTooLarge": "El archivo es demasiado grande (máx. 18 MB)"
	},
	"loadMessagesError": "No se pudieron cargar los mensajes. Revisa los registros del servidor.",
	"messageStatus": {
		"pending": "Pendiente",
		"sent": "Enviado",
		"delivered": "Entregado",
...
var dashboard = {
	...
	"charts": {
		"title": "Analíticas de mensajes",
		"period": {
			"24h": "24 h",
			"7d": "7 d",
			"30d": "30 d"
		},
		"overTime": "Mensajes a lo largo del tiempo",
		"byType": "Mensajes por tipo",
		"topChats": "Chats principales",
		"sent": "Enviados",
		"received": "Recibidos",
		"messages": "Mensajes",
		"empty": "Sin actividad de mensajes en este período.",
		"error": "No se pudieron cargar las analíticas de mensajes. Revisa los registros del servidor."
	}
};
var sessionStatus = {
	"created": "Nueva",
...
var sessions = {
	...
	"feedDisconnected": "Actualizaciones en vivo desconectadas",
	...
	"create": {
		...
		"hint": "Usa solo letras minúsculas, números y guiones. Ejemplo: <code>soporte-cliente</code>, <code>bot-1</code>",
	...
	"delete": {
		...
		"message": "¿Seguro que quieres eliminar la sesión <strong>\"{{name}}\"</strong>?",
	...
	"qr": {
		...
		"step1": "<strong>1.</strong> Abre WhatsApp en tu teléfono",
		"step2": "<strong>2.</strong> Toca <strong>Menú</strong> → <strong>Dispositivos vinculados</strong>",
		"step3": "<strong>3.</strong> Toca <strong>Vincular dispositivo</strong> y escanea este QR",
	...
	"details": {
		...
		"created": "Creado",
		"lastActive": "Última actividad",
		"autoRejectCalls": "Rechazar llamadas automáticamente",
		"autoRejectCallsHint": "Las llamadas entrantes se rechazan en cuanto suenan. El webhook call.received se envía igualmente antes. Se aplica a la próxima llamada; no hace falta reiniciar. Solo con el motor Baileys: whatsapp-web.js no puede rechazar llamadas."
	},
	"proxy": {
	...
	"toasts": {
		...
		"actionRequiredDesc": "Esta sesión necesita tu atención. Abre la sesión para ver qué hacer.",
	...
	"unlink": {
		...
		"message": "¿Desvincular la sesión <strong>\"{{name}}\"</strong> de la cuenta de WhatsApp?",
		"warning": "WhatsApp elimina este dispositivo de los Dispositivos vinculados de la cuenta y la sesión se detiene. Para reconectar se requiere un nuevo código QR o código de emparejamiento. Para borrar también todos los datos locales, elimine la sesión después.",
		"confirm": "Desvincular",
		"successTitle": "Dispositivo desvinculado",
		"success": "Desvinculación completada: se cerró la sesión del dispositivo y se borraron las credenciales locales. Para reconectar se requiere un nuevo código QR o código de emparejamiento.",
		"failedTitle": "Error al desvincular",
		"failed": "No se pudo desvincular la sesión.",
		"incompleteTitle": "Desvinculación incompleta",
		"incomplete": "La sesión se detuvo localmente, pero la operación de cierre de sesión está incompleta — es posible que el dispositivo siga vinculado. Inicie la sesión y vuelva a intentar la desvinculación."
	},
	"pairing": {
		"tabQr": "Código QR",
		"tabPhone": "Vincular con número de teléfono",
		"phoneLabel": "Número de teléfono",
		"phonePlaceholder": "ej., 919876543210",
		"phoneHint": "Solo dígitos (sin +, espacios ni guiones) en formato internacional (código de país + número).",
		"relinkWarning": "En el motor whatsapp-web.js, pedir un código para un número que ya tiene una sesión vinculada puede hacer que WhatsApp desvincule ese dispositivo. Usa la pestaña de código QR si esa sesión debe seguir activa.",
		"invalidPhone": "Introduce un número de teléfono válido: 6-15 dígitos, primero el código de país, sin símbolos.",
		"generateButton": "Generar código de vinculación",
		"generating": "Generando código de vinculación...",
		"codeLabel": "Tu código de vinculación",
		"changeNumber": "Cambiar número / Solicitar nuevo código",
		"instructions": "Instrucciones de vinculación",
		"step1": "<strong>1.</strong> Abre WhatsApp en tu teléfono",
		"step2": "<strong>2.</strong> Toca <strong>Menú</strong> o <strong>Ajustes</strong> y selecciona <strong>Dispositivos vinculados</strong>",
		"step3": "<strong>3.</strong> Toca <strong>Vincular dispositivo</strong> y luego toca <strong>Vincular con número de teléfono</strong>",
		"step4": "<strong>4.</strong> Introduce en tu teléfono el código de 8 caracteres que se muestra arriba",
		"waitingConnection": "Esperando a que tu teléfono se vincule…"
	},
	"start": {
		"teardownPendingTitle": "Iniciando sesión",
		"teardownPending": "El borrado de credenciales de esta sesión aún está en curso. Espere un momento e inténtelo de nuevo.",
		"errorTitle": "Error al iniciar"
	},
	"restriction": {
		"reachout_timelock": "Chats nuevos bloqueados",
		"tos_block": "Bloqueado por WhatsApp",
		"proxy_block": "Conexión bloqueada",
		"until": "hasta {{date}}"
	}
};
var webhooks = {
	...
	"filters": {
		...
		"contactPlaceholder": "Número o ID de WhatsApp...",
		"textPlaceholder": "Texto a buscar...",
		...
		"fields": {
			...
			"isGroup": "Es chat de grupo",
			"kind": "Chat kind",
			"fromMe": "Enviado por mí",
		...
		"operatorLabel": "Operador de filtro",
		"valueLabel": "Valor de filtro"
	},
	"columns": {
		"url": "URL",
		"events": "Eventos",
...
var apiKeys = {
	...
	"confirm": {
		...
		"deleteMessage": "¿Seguro que quieres eliminar permanentemente <strong>{{name}}</strong>? Esta acción no se puede deshacer.",
		"revokeMessage": "¿Seguro que quieres revocar <strong>{{name}}</strong>? Dejará de funcionar.",
		"delete": "Eliminar",
		"revoke": "Revocar"
	},
	"actions": {
	...
	"sessions": {
		"label": "Acceso a sesiones",
		"hint": "Elige las sesiones que podrá usar esta clave.",
		"all": "Todas las sesiones",
		"empty": "Todavía no hay sesiones. Esta clave podrá acceder a todas cuando existan.",
		"restricted": "{{count}} seleccionadas",
		"editTitle": "Editar acceso a sesiones",
		"save": "Guardar",
		"choose": "Elegir sesiones",
		"leaveAll": "Dejar para todas las sesiones"
	}
};
var logs = {
	...
	"empty": {
		...
		"filteredTitle": "Sin coincidencias en esta página",
		"filteredDescription": "La búsqueda filtra solo la página actual. Bórrala, navega entre páginas o usa el filtro de severidad para acotar en el servidor.",
		"filteredServerDescription": "Ningún registro coincide con estos filtros. Ajusta el filtro de severidad para ampliar la búsqueda."
	}
};
var messageTester = {
	...
	"locationLatitude": "Latitud",
	"locationLongitude": "Longitud",
	"locationDescription": "Descripción",
	"locationAddress": "Dirección",
	"contactName": "Nombre del contacto",
	"contactNamePlaceholder": "Jane Doe",
	"contactNumber": "Número del contacto",
	"pollQuestion": "Pregunta de la encuesta",
	"pollQuestionPlaceholder": "¿Dónde nos reunimos?",
	"pollOptions": "Opciones de la encuesta",
	"pollOptionPlaceholder": "Opción {{index}}",
	"pollOptionsHint": "Entre 2 y 12 opciones",
	"addOption": "Añadir opción",
	"removeOption": "Quitar opción",
	"allowMultipleAnswers": "Permitir varias respuestas",
	"forwardFromChatId": "ID del chat de origen",
	"forwardFromPlaceholder": "628123456789@c.us",
	"forwardFromHint": "Déjalo vacío para reenviar desde el destinatario actual",
	"forwardToChatId": "ID del chat de destino",
	"forwardToPlaceholder": "Número de teléfono o ID de chat",
	"forwardMessageId": "ID del mensaje",
	"forwardMessageIdHint": "ID del mensaje que se va a reenviar",
	"bulkRecipients": "Destinatarios",
	"bulkRecipientsUpload": "Subir CSV/TXT",
	"bulkRecipientsPlaceholder": "+62812345678",
	"bulkRecipientsHint": "Un número de teléfono o ID de chat por línea (máx. 100)",
	"bulkRecipientsCount": "Destinatarios: {{count}}",
	"bulkDelay": "Retraso entre mensajes (ms)",
	"bulkDelayHint": "1000–60000 ms (predeterminado: 3000)",
	"send": "Enviar mensaje",
	"sending": "Enviando...",
	...
	"batch": {
		...
		"progress": "Enviados {{sent}} de {{total}} · {{failed}} fallidos · {{pending}} pendientes",
...
var templates = {
	...
	"noPlaceholders": "Usa marcadores {{name}} para probar sustituciones.",
	...
	"actions": { "copyName": "Copiar nombre de plantilla" },
	"empty": {
		...
		"loadErrorTitle": "No se pudieron cargar las plantillas",
		"forbiddenTitle": "Sin acceso a las plantillas",
		"forbiddenDesc": "Las plantillas requieren una clave API con el rol de operador o administrador."
	},
	"toasts": {
...
var infrastructure = {
	...
	"database": {
		...
		"schema": "Esquema",
		"schemaDesc": "Esquema de PostgreSQL (ignorado para SQLite). Predeterminado 'public'. El esquema debe existir previamente.",
	...
	"engine": {
		...
		"headlessDesc": "Ejecuta el navegador sin interfaz visible (recomendado para producción).",
		"sessionDataPath": "Ruta de datos de sesión",
		"browserArgs": "Argumentos del navegador",
		"noBrowser": "Este motor se conecta por WebSocket: no tiene navegador, por lo que no hay ajustes de modo headless ni de argumentos del navegador. El motor activo se aplica tras reiniciar.",
		"restartNote": "Cambiar el motor surte efecto tras reiniciar el servidor.",
		"webVersion": "Compilación de WhatsApp Web",
		"webVersionNative": "automático (predeterminado de whatsapp-web.js)",
		"webVersionSource": {
			"pinned": "fijado mediante WWEBJS_WEB_VERSION",
			"auto": "resuelto automáticamente, compilación estable conocida actual",
			"native": "selección automática nativa de whatsapp-web.js"
		}
	},
	"redis": {
		"title": "Redis",
		...
		"bullMqUrlCopied": "URL del panel de Bull MQ copiada",
		"bullMqUrlHint": "Ábrelo con una clave de API ADMIN: una pestaña del navegador no puede autenticarse."
	},
	"storage": {
	...
	"restart": {
		...
		"idleDesc": "La configuración se ha guardado en <code>.env.generated</code>.<br/>Es necesario reiniciar el servidor para aplicar los cambios.",
	...
	"toasts": { "saveFailed": "Error al guardar" },
	"envPinNote": "Fijado por la variable de entorno {{name}}: este es el valor en ejecución; los cambios del panel no se aplicarán hasta que esa variable se elimine.",
	"pendingRestartNote": "Guardado, pero aún no aplicado: reinicia el servidor para que este cambio surta efecto.",
	"migration": {
		"title": "Atención: esto cambia el backend de datos",
		"dbWarning": "La nueva base de datos comienza vacía. Descarga ahora una copia de seguridad de tus datos actuales (mientras sigues en la base de datos anterior) y luego restáurala después del reinicio.",
		"storageWarning": "Los archivos multimedia existentes no se trasladan automáticamente al nuevo backend de almacenamiento; permanecerán en la ubicación anterior.",
		"downloadBackup": "Descargar copia de seguridad primero",
		"backupTitle": "Copia de seguridad y restauración de datos",
		"backupHint": "Exporta todos los datos como JSON antes de cambiar de base de datos y luego impórtalos tras el cambio. La copia de seguridad contiene secretos de webhook y credenciales de proxy en texto plano: guárdala de forma segura y elimínala después de restaurarla.",
		...
		"importConfirm": "La importación REEMPLAZARÁ todos los datos actuales con la copia de seguridad ({{rows}} filas). Esto no se puede deshacer. ¿Continuar?",
		"invalidFile": "Ese archivo no es una copia de seguridad de datos válida de OpenWA.",
		"importTooLarge": "La copia de seguridad supera el límite de la solicitud. Aumenta BODY_SIZE_LIMIT en el servidor e inténtalo de nuevo."
	},
	"statusLoadError": "No se pudo cargar el estado actual de la infraestructura. Actualiza para reintentar."
};
var plugins = {
	"title": "Plugins",
	"subtitle": "Instala, configura y gestiona extensiones",
	"refresh": "Actualizar",
	"builtIn": "Integrado",
	...
	"uninstallConfirm": "¿Desinstalar \"{{name}}\"? Esto elimina sus archivos.",
	"empty": {
	...
	"config": {
		...
		"uiHandshakeError": "La interfaz de configuración del plugin no se inició. Usa el formulario inferior si está disponible.",
	...
	"rail": {
		...
		"none": "Ninguno habilitado todavía"
	},
	"installModal": {
		...
		"trustWarning": "Los plugins se ejecutan con todos los privilegios del proceso de la puerta de enlace: el modo aislado contiene fallos, no código malicioso. Instala solo plugins en los que confíes.",
	...
	"sessions": {
		...
		"activationDesc": "Elige para qué sesiones se ejecuta este complemento.",
		...
		"perSessionTitle": "Configuración por sesión",
		"perSessionDesc": "Anula la configuración global para una sesión; los campos sin modificar heredan el valor global.",
	...
	"instances": {
		"title": "Instancias",
		"description": "Aprovisiona instancias por cuenta para esta integración. Cada instancia tiene su propio secreto de firma y URL de entrada.",
		"create": "Crear instancia",
		"save": "Save",
		"empty": "Aún no hay instancias. Crea una para obtener una URL de entrada y un secreto.",
		...
		"form": {
			...
			"instanceIdPlaceholder": "p. ej. acme-support",
			"instanceIdHint": "Letras, números, guiones y guiones bajos (máx. 64).",
			"sessionScope": "Ámbito de sesión (opcional)",
			"sessionScopePlaceholder": "Déjalo en blanco para todas las sesiones",
			"verifyToken": "Token de verificación (opcional)",
			"verifyTokenPlaceholder": "Token que el proveedor devuelve al verificar",
			"secret": "Secreto de ingress (opcional)",
			"secretPlaceholder": "Secreto del webhook del proveedor (p. ej. Chatwoot)",
			"secretHint": "Déjalo en blanco para generarlo automáticamente (se muestra una sola vez). Si el proveedor fija su propio secreto de webhook, pégalo aquí: uno autogenerado no coincidirá.",
			"config": "Configuración (JSON opcional)",
			"configPlaceholder": "{ }"
		},
		"created": {
			"title": "Instancia creada",
			"hint": "Copia el secreto ahora — solo se muestra una vez.",
			"secret": "Secreto de firma",
			"ingressUrls": "URL(s) de entrada"
		},
		"regenerate": {
			"title": "Regenerar secreto",
			"confirm": "¿Regenerar el secreto de firma de {{id}}? El secreto actual dejará de funcionar de inmediato.",
			"action": "Regenerar"
		},
		"edit": { "title": "Editar {{id}}" },
		"delete": {
			"title": "Eliminar instancia",
			"confirm": "¿Eliminar la instancia {{id}}? Su URL de entrada y secreto dejarán de funcionar de inmediato.",
			"action": "Eliminar"
		},
		"actions": {
			"regenerate": "Regenerar secreto",
			"edit": "Editar",
			"delete": "Eliminar",
			"copy": "Copiar",
			"save": "Guardar",
		...
		"errors": {
			"invalidId": "El ID de instancia debe contener letras, números, guiones o guiones bajos (máx. 64).",
			"invalidJson": "La configuración debe ser JSON válido.",
			"invalidSecret": "El secreto debe tener al menos 16 caracteres, o déjalo en blanco para generarlo automáticamente.",
			"duplicateId": "Ya existe una instancia con ese ID."
		},
		"toasts": {
...
//#endregion
export { apiKeys, chats, common, dashboard, es_default as default, errorBoundary, infrastructure, login, logs, messageTester, nav, plugins, search, sessionStatus, sessions, templates, theme, toast, webhooks };
