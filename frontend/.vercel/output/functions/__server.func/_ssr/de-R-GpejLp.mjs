//#region node_modules/.nitro/vite/services/ssr/assets/de-R-GpejLp.js
...
var chats = {
	...
	"loadOlderMessagesError": "Ältere Nachrichten konnten nicht geladen werden. Zum erneuten Versuch nach oben scrollen.",
	...
	"promptButtons": "Nachrichtenoptionen",
	...
	"status": {
		...
		"composeText": "Text",
		"composeImage": "Bild",
		"recipients": "Wer das sehen kann",
		"recipientsHint": "Baileys benötigt eine Empfängerliste; whatsapp-web.js verwendet deine Status-Datenschutz-Zielgruppe.",
		...
		"orLabel": "oder",
		"post": "Posten",
		"posted": "Status gepostet",
		"postFailed": "Status konnte nicht gepostet werden",
		"imageFile": "Statusbild"
	},
	"channels": {
	...
	"errors": {
		...
		"clickButton": "Schaltfläche konnte nicht angeklickt werden",
...
var sessions = {
	...
	"feedDisconnected": "Live-Updates getrennt",
	...
	"details": {
		...
		"created": "Erstellt",
		"lastActive": "Zuletzt aktiv",
		"autoRejectCalls": "Anrufe automatisch ablehnen",
		"autoRejectCallsHint": "Eingehende Anrufe werden abgelehnt, sobald sie klingeln. Der Webhook call.received wird trotzdem zuerst ausgelöst. Gilt ab dem nächsten Anruf — kein Neustart nötig. Nur mit der Baileys-Engine: whatsapp-web.js kann keine Anrufe ablehnen."
	},
	"proxy": {
	...
	"toasts": {
		...
		"actionRequiredDesc": "Diese Sitzung braucht deine Aufmerksamkeit. Öffne die Sitzung, um zu sehen, was zu tun ist.",
	...
	"unlink": {
		"title": "Gerät trennen",
		"message": "Sitzung <strong>\"{{name}}\"</strong> vom WhatsApp-Konto trennen?",
		"warning": "WhatsApp entfernt dieses Gerät aus den verknüpften Geräten des Kontos und die Sitzung wird beendet. Für eine erneute Verbindung ist ein neuer QR-Code oder Kopplungscode erforderlich. Um auch alle lokalen Daten zu löschen, löschen Sie die Sitzung anschließend.",
		"confirm": "Trennen",
		"successTitle": "Gerät getrennt",
		"success": "Trennung abgeschlossen: Das Gerät wurde abgemeldet und die lokalen Sitzungsdaten wurden gelöscht. Zum erneuten Verbinden ist ein neuer QR-Scan oder Kopplungscode erforderlich.",
		"failedTitle": "Trennen fehlgeschlagen",
		"failed": "Die Sitzung konnte nicht getrennt werden.",
		"incompleteTitle": "Trennung unvollständig",
		"incomplete": "Die Sitzung wurde lokal beendet, aber der Abmeldevorgang ist unvollständig — das Gerät ist möglicherweise noch verknüpft. Starten Sie die Sitzung und wiederholen Sie die Trennung."
	},
	"pairing": {
		"tabQr": "QR-Code",
		...
		"relinkWarning": "Auf der whatsapp-web.js-Engine kann eine Code-Anfrage für eine Nummer, die bereits eine verknüpfte Sitzung hat, dazu führen, dass WhatsApp dieses Gerät trennt. Nutze den QR-Tab, wenn diese Sitzung aktiv bleiben muss.",
	...
	"start": {
		"teardownPendingTitle": "Sitzung wird gestartet",
		"teardownPending": "Ein Anmeldedatenabbau für diese Sitzung läuft noch. Warten Sie einen Moment und versuchen Sie es erneut.",
		"errorTitle": "Start fehlgeschlagen"
	},
	"restriction": {
		"reachout_timelock": "Neue Chats blockiert",
		"tos_block": "Von WhatsApp gesperrt",
		"proxy_block": "Verbindung gesperrt",
		"until": "bis {{date}}"
	}
};
var webhooks = {
	...
	"filters": {
		...
		"fieldLabel": "Filterfeld",
		"operatorLabel": "Filteroperator",
		"valueLabel": "Filterwert"
	},
	"columns": {
		"url": "URL",
		"events": "Ereignisse",
...
var templates = {
	...
	"actions": { "copyName": "Vorlagenname kopieren" },
	"empty": {
		...
		"loadErrorTitle": "Vorlagen konnten nicht geladen werden",
		"forbiddenTitle": "Kein Zugriff auf Vorlagen",
		"forbiddenDesc": "Vorlagen erfordern einen API-Schlüssel mit der Rolle Operator oder Admin."
	},
	"toasts": {
...
var apiKeys = {
	...
	"actions": {
		...
		"revoke": "Widerrufen",
		"delete": "Löschen",
		"editSessions": "Sitzungen bearbeiten"
	},
	"sessions": {
		"label": "Sitzungszugriff",
		"hint": "Wählen Sie die Sitzungen, die dieser Schlüssel nutzen darf.",
		"all": "Alle Sitzungen",
		"empty": "Noch keine Sitzungen. Dieser Schlüssel kann auf alle zugreifen, sobald welche existieren.",
		"restricted": "{{count}} ausgewählt",
		"editTitle": "Sitzungszugriff bearbeiten",
		"save": "Speichern",
		"choose": "Sitzungen wählen",
		"leaveAll": "Für alle Sitzungen belassen"
	}
};
var logs = {
	...
	"empty": {
		...
		"filteredTitle": "Keine Treffer auf dieser Seite",
		"filteredDescription": "Die Suche filtert nur die aktuelle Seite. Leere sie, blättere weiter oder grenze serverseitig über den Severity-Filter ein.",
		"filteredServerDescription": "Keine Protokolle passen auf diese Filter. Passe den Severity-Filter an, um die Suche zu erweitern."
	}
};
var messageTester = {
	...
	"bulkRecipientsUpload": "CSV/TXT hochladen",
...
var infrastructure = {
	...
	"envPinNote": "Durch die Umgebungsvariable {{name}} festgelegt — dies ist der aktuell verwendete Wert. Änderungen im Dashboard werden erst wirksam, wenn diese Variable entfernt wird.",
	"pendingRestartNote": "Gespeichert, aber noch nicht übernommen — starten Sie den Server neu, damit diese Änderung wirksam wird.",
	"migration": {
	...
	"toasts": { "saveFailed": "Speichern fehlgeschlagen" },
...
var plugins = {
	...
	"installModal": {
		...
		"trustWarning": "Plugins laufen mit den vollen Prozessrechten des Gateways — die Sandbox fängt Abstürze ab, keinen Schadcode. Installiere nur Plugins, denen du vertraust.",
...
//#endregion
export { apiKeys, chats, common, dashboard, de_default as default, errorBoundary, infrastructure, login, logs, messageTester, nav, plugins, search, sessionStatus, sessions, templates, theme, toast, webhooks };
