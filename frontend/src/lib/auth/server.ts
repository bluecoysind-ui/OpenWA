...
// Local `npm run dev` (UI on :2785, same as production Docker URL). Browsers may
// send Origin as any of these loopback forms — trusting only `localhost` rejects
// `127.0.0.1` and breaks email/password with "Invalid origin".
