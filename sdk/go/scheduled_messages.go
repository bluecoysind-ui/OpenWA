...
func (s *ScheduledMessagesService) List(ctx context.Context, sessionID string) ([]ScheduledMessageRecord, error) {
	var out []ScheduledMessageRecord
	err := s.client.do(ctx, "GET", s.base(sessionID), nil, nil, &out)
	return out, err
}

func (s *ScheduledMessagesService) Create(ctx context.Context, sessionID string, body CreateScheduledMessageRequest) (*ScheduledMessageRecord, error) {
	var out ScheduledMessageRecord
...
func (s *ScheduledMessagesService) Get(ctx context.Context, sessionID, jobID string) (*ScheduledMessageRecord, error) {
	var out ScheduledMessageRecord
...
func (s *ScheduledMessagesService) Update(ctx context.Context, sessionID, jobID string, body UpdateScheduledMessageRequest) (*ScheduledMessageRecord, error) {
	var out ScheduledMessageRecord
